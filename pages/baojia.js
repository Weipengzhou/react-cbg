    ...
    render(){
        return(
            <div className='Baojia'>
             <Head title="免费报价" url={'www.zxjmy.com/baojia'} title='装修花多少钱？_装修报价单_家装预算表_房屋装修预算清单_金蚂蚁装修网' description='金蚂蚁装修网(m.zxjmy.com）如实的告诉您的房子装修需要花费多少钱并且为您推荐口碑好的装修公司和免费的装修设计方案,装修报价单,房屋装修预算清单以及家装预算表。' url={`www.zxjmy.com/baojia`}/>
