    ...
    render() {
        ...
        return (
            <div className='jieshao'>
                <Head title={`${company.companyIntro.name}介绍_${company.companyIntro.city}装修公司哪家好？如何选？_${company.companyIntro.city}金蚂蚁装修网`} description={`${company.companyIntro.name}介绍,${company.companyIntro.city}金蚂蚁装修网为您免费分享${company.companyIntro.city}装修公司排名,哪家好？`} />
